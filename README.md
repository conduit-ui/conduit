...
• github-zero - Bypass GitHub's feature paywalls  
...
- **GitHub**: Basic automation requires paid tiers
- **Docker Desktop**: Now requires subscriptions for basic use
...
| **🐙 github-zero** | Git workflows | GitHub CLI (limited) |
...
- **🏆 Corporate Tools Replaced**: Spotify Desktop, Docker Desktop, GitHub limitations, Notion lock-in
